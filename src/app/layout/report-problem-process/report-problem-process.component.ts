...
@Component({
  selector: 'layout-report-problem-process',
  templateUrl: './report-problem-process.component.html',
  styleUrls: ['./report-problem-process.component.scss']
})
export class ReportProblemProcessComponent implements OnInit {
  temImgUrl: SafeUrl;
  uploadFile: File;
  filePath: string;
  isPreview: boolean;
  container = 'report-problem-process';
