...
@Component({
  selector: 'app-yield-analyze',
  templateUrl: './yield-analyze.component.html',
  styleUrls: ['./yield-analyze.component.scss']
})
export class YieldAnalyzeComponent implements OnInit {
  ...
  cur_item;
  @ViewChild ('yeildChart') yeildChart: YieldRateChartComponent;
  ...
  async queryOp (options) {
    ...
    this.yeildChart.queryOp(options);
  }
