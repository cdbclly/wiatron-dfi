...
export class UploadApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public getTemplete(process: any = {}, modelType: any = {}, material: any = {}, factor: any = {}, action: any = {}, stageID: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/uploads/getTemplete";
    let _routeParams: any = {};
    ...
    if (typeof material !== 'undefined' && material !== null) _urlParams.material = material;
    if (typeof factor !== 'undefined' && factor !== null) _urlParams.factor = factor;
