...
/**
 * Api services for the `MOHCondition` model.
 */
@Injectable()
export class MOHConditionApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `MOHCondition` object.)
   * </em>
   */
