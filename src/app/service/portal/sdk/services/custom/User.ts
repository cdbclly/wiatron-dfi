...
export class UserApi extends BaseLoopBackApi {
  ...
  /**
   * Add a related item by id for apps.
   *
   * @param {any} id user id
   *
   * @param {any} fk Foreign key for apps
   ...
   * </em>
   */
  public linkApps(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/apps/rel/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Remove the apps relation to an item by id.
   *
   * @param {any} id user id
   *
   * @param {any} fk Foreign key for apps
   ...
   * This method returns no data.
   */
  public unlinkApps(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/users/:id/apps/rel/:fk";
    let _routeParams: any = {
  ...
  /**
   * Check the existence of apps relation to an item by id.
   *
   * @param {any} id user id
   *
   * @param {any} fk Foreign key for apps
   ...
   * </em>
   */
  public existsApps(id: any, fk: any, customHeaders?: Function): Observable<any> {
