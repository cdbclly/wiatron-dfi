...
export class ProjectApi extends BaseLoopBackApi {
  ...
  /**
   * Fetches belongsTo relation profitCenter.
   *
   * @param {any} id Project id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public getProfitCenter(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Projects/:id/profitCenter";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Add a related item by id for stages.
   *
   * @param {any} id Project id
   *
   * @param {any} fk Foreign key for stages
   ...
   * </em>
   */
  public linkStages(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Projects/:id/stages/rel/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Remove the stages relation to an item by id.
   *
   * @param {any} id Project id
   *
   * @param {any} fk Foreign key for stages
   ...
   * This method returns no data.
   */
  public unlinkStages(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Projects/:id/stages/rel/:fk";
    let _routeParams: any = {
  ...
  /**
   * Check the existence of stages relation to an item by id.
   *
   * @param {any} id Project id
   *
   * @param {any} fk Foreign key for stages
   ...
   * </em>
   */
  public existsStages(id: any, fk: any, customHeaders?: Function): Observable<any> {
