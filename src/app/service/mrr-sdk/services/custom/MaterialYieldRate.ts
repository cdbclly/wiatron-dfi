...
/**
 * Api services for the `MaterialYieldRate` model.
 */
@Injectable()
export class MaterialYieldRateApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id MaterialYieldRate id
   *
