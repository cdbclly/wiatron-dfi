...
/**
 * Api services for the `ExternalUser` model.
 */
@Injectable()
export class ExternalUserApi extends BaseLoopBackApi {
  ...
  /**
   * Queries accessTokens of ExternalUser.
   *
   * @param {any} id ExternalUser id
   *
   * @param {object} filter 
  ...
  /**
   * Counts accessTokens of ExternalUser.
   *
   * @param {any} id ExternalUser id
   *
  ...
  public countAccessTokens(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ExternalUsers/:id/accessTokens/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   *  - `ACLs` – `{any}` - 
   */
  public updateUserACL(userId: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/ExternalUsers/updateUserACL/";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
  ...
  /**
   * @ngdoc method
   * @name sdk.ExternalUser#getCurrent
   * @methodOf sdk.ExternalUser
   *
   * @description
   *
  ...
  public getCurrent(filter: LoopBackFilter = {}): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() + "/ExternalUsers" + "/:id";
   ...
   * call to {@link sdk.ExternalUser#login} or
   * {@link sdk.ExternalUser#getCurrent}. Return null when there
   ...
   * call to {@link sdk.ExternalUser#login}
   *
  ...
  /**
   * @name sdk.ExternalUser#isAuthenticated
   *
  ...
  /**
   * @name sdk.ExternalUser#getCurrentId
   *
